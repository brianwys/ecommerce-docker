...
def kpi_predictor():
    data_sources = "./user_files/first_improvement/data_sum_per_region_date_all_dept.csv"
    ...
    output_file = "./user_files/final_result/final_combined_result.csv"
...
def plot_data(div_name):
    file_path = "./user_files/final_result/final_combined_result.csv"
    final_1 = pd.read_csv(file_path)
    ...
    image_path = "./static/plot.png"  # Change the path as needed
...
def ratio_kpi_generator(df):
    ...
    with open('./user_files/final_result/kpi_results.json', 'w') as f:
